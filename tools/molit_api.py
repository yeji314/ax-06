...
# 주요 거점역 → 각 구까지 평균 대중교통 출퇴근 시간(분)
# 출처: 카카오/네이버 지도 출퇴근 시간(러시아워 평균) 추정치, ±10분 오차 허용
COMMUTE_TIME_FROM_HUB: dict[str, dict[str, int]] = {
    "시청역": {
        "중구": 5, "종로구": 8, "용산구": 18, "마포구": 18, "서대문구": 18,
        "성동구": 22, "동대문구": 22, "영등포구": 25, "은평구": 28, "광진구": 28,
        "성북구": 25, "강남구": 28, "서초구": 30, "동작구": 30, "관악구": 35,
        "송파구": 40, "강동구": 45, "구로구": 38, "양천구": 38, "강서구": 45,
        "금천구": 45, "중랑구": 35, "강북구": 40, "노원구": 50, "도봉구": 50,
    },
    "강남역": {
        "강남구": 5, "서초구": 8, "송파구": 18, "동작구": 18, "관악구": 18,
        "광진구": 25, "성동구": 22, "용산구": 25, "영등포구": 25, "구로구": 30,
        "금천구": 25, "양천구": 35, "마포구": 30, "중구": 25, "종로구": 30,
        "동대문구": 35, "성북구": 35, "은평구": 45, "서대문구": 35, "강서구": 40,
        "강동구": 30, "노원구": 50, "도봉구": 55, "강북구": 50, "중랑구": 35,
    },
    "여의도역": {
        "영등포구": 5, "마포구": 12, "동작구": 15, "용산구": 12, "관악구": 18,
        "구로구": 18, "양천구": 20, "강서구": 25, "중구": 15, "종로구": 18,
        "서대문구": 15, "은평구": 25, "강남구": 25, "서초구": 22, "성동구": 25,
        "광진구": 28, "송파구": 35, "강동구": 40, "동대문구": 28, "성북구": 30,
        "금천구": 25, "노원구": 50, "도봉구": 50, "강북구": 45, "중랑구": 35,
    },
    "잠실역": {
        "송파구": 5, "강동구": 12, "광진구": 12, "강남구": 15, "성동구": 18,
        "서초구": 18, "용산구": 25, "동작구": 25, "동대문구": 22, "중구": 25,
        "종로구": 30, "마포구": 30, "영등포구": 32, "성북구": 30, "관악구": 28,
        "양천구": 40, "구로구": 40, "강서구": 45, "노원구": 35, "중랑구": 22,
        "강북구": 40, "도봉구": 45, "은평구": 45, "서대문구": 35, "금천구": 40,
    },
    "광화문역": {
        "종로구": 5, "중구": 8, "용산구": 18, "마포구": 18, "서대문구": 15,
        "성동구": 22, "동대문구": 18, "영등포구": 25, "은평구": 25, "광진구": 28,
        "성북구": 22, "강남구": 30, "서초구": 32, "동작구": 32, "관악구": 35,
        "송파구": 40, "강동구": 45, "구로구": 38, "양천구": 38, "강서구": 45,
        "금천구": 45, "중랑구": 35, "강북구": 38, "노원구": 48, "도봉구": 50,
    },
    # 별칭
    "시청": {}, "강남": {}, "여의도": {}, "잠실": {}, "광화문": {},
}
# 별칭에 본 매핑 복사
for hub, alias in [("시청역", "시청"), ("강남역", "강남"), ("여의도역", "여의도"),
                    ("잠실역", "잠실"), ("광화문역", "광화문")]:
    COMMUTE_TIME_FROM_HUB[alias] = COMMUTE_TIME_FROM_HUB[hub]
...
# 한강에 직접 인접한 법정동 — '한강 근처/한강변/한강뷰' 요청 시 정밀 필터링용
# 기준: 한강 본류와 도보 ~10분 이내 또는 단지가 한강 조망 가능
HANGANG_RIVERSIDE_DONGS: set[str] = {
    # 강남구
    "압구정동", "청담동", "삼성동", "대치동",
    # 서초구
    "반포동", "잠원동",
    ...
    "자양동", "광장동", "구의동",
    # 성동구
    "옥수동", "성수동1가", "성수동2가", "응봉동", "금호동",
    # 용산구
    "이촌동", "한남동", "보광동", "용산동", "한강로",
    # 마포구
    "망원동", "합정동", "상수동", "당인동", "현석동", "하중동",
    # 영등포구
    "여의도동", "양화동", "양평동", "당산동",
    # 강서구
    "가양동", "마곡동", "방화동", "염창동",
